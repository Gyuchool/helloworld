...
public class QuerydslPagingItemReader<T> extends AbstractPagingItemReader<T> {
     ...
     * cc. https://docs.spring.io/spring-batch/docs/4.3.x/api/org/springframework/batch/item/database/JpaPagingItemReader.html#setTransacted-boolean-
     * - true: reader에 의해 item의 일관성을 유지한다. 격리 시킨다 <br/>
    ...
    protected JPAQuery<T> createQuery(QuerydslNoOffsetOptions<T> options) {
        if (options == null) {
